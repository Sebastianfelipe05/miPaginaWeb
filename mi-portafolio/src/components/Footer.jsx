  ...
  return (
    <footer className="bg-primary-dark text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <img src="/imgs/logo.jpg" alt="SebaskiTek-X" className="h-12 w-12 rounded-lg" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button onClick={() => scrollToSection('gallery')} className="hover:text-accent transition">
                  Proyectos
                </button>
              </li>
            </ul>
          ...
          {/* Más enlaces */}
          <div>
            <h4 className="text-lg font-semibold mb-4">Más</h4>
            <ul className="space-y-2">
              <li>
                <button onClick={() => scrollToSection('blog')} className="hover:text-accent transition">
                  Blog
                </button>
              </li>
              <li>
        ...
        <div className="border-t border-primary-medium pt-8 text-center">
          <p className="text-accent">
            © 2025 Sebastian Felipe Solano Cabrera - SebaskiTek-X. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
